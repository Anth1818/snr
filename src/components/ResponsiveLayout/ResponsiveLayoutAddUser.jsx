                      ...
                      <Form>
                        ...
                        >
                          <TextField
                            ...
                            error={Boolean(
                              props.errors.userFirstName &&
                                props.touched.userFirstName
                            )}
                            size="small"
                            sx={{ width: "300px" }}
                          />
                          <TextField
                            ...
                            error={Boolean(
                              props.errors.userLastName &&
                                props.touched.userLastName
                            )}
                            size="small"
                            sx={{ width: "300px" }}
                          />
                          ...
                          <TextField
                            ...
                            error={Boolean(
                              props.errors.userPhoneNumber &&
                                props.touched.userPhoneNumber
                            )}
                            size="small"
                            sx={{ width: "300px" }}
                          />
                          <TextField
                            ...
                            error={Boolean(
                              props.errors.userPhoneNumber2 &&
                                props.touched.userPhoneNumber2
                            )}
                            size="small"
                            sx={{ width: "300px" }}
                          />
                          ...
                          <Autocomplete
                            ...
                            onChange={(e, value) => {
                              props.setFieldValue(
                                ...
                                value !== null
                                  ? value.name
                                  : initialValuesNewUser.userGender
                              );
                            }}
                            sx={{ width: "300px" }}
                            renderInput={(params) => (
                          ...
                          <Autocomplete
                            ...
                            onChange={(e, value) => {
                              props.setFieldValue(
                                ...
                                value !== null
                                  ? value.name
                                  : initialValuesNewUser.useOffice
                              );
                            }}
                            sx={{ width: "300px" }}
                            renderInput={(params) => (
                          ...
                          <Autocomplete
                            ...
                            onChange={(e, value) => {
                              props.setFieldValue(
                                ...
                                value !== null
                                  ? value.name
                                  : initialValuesNewUser.userPosition
                              );
                            }}
                            sx={{ width: "300px" }}
                            renderInput={(params) => (
